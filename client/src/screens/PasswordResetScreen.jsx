  ...
  return serverStatus ? (
    <Center minH='90vh'>
        <VStack>
            ...
            <Link to='/login'><Button variant='outline' colorScheme='cyan' w='300px'>Login</Button></Link>
            <Link to='/products'><Button variant='outline' colorScheme='cyan' w='300px'>Products</Button></Link>
        </VStack>
    </Center> 
  ) : (
    <Formik
                ...
                <Box 
                    ...
                    boxShadow={{ base: 'none', md: 'xl'}} >
                        <Stack spacing='6' as='form' onSubmit={formik.handleSubmit}>
                            {error && (
                                <Alert 
                                    status='error' flexDirection='column' alignItems='center' justifyContent='center'
                                    textAlign='center'>
                                        <AlertIcon />
